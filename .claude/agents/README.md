...
playwright-cli MCPとfrontend-design skillを活用したUI改善専門エージェント群。
...
### 2. playwright-cli MCPの設定
`.mcp.json` にplaywright-cliサーバーが設定されていること。
...
| ディレクトリ | 内容 |
|-------------|------|
| `screenshots/` | playwright-cliスクリーンショット |

...
- [シナプレ管理くん 詳細要件定義書（v1）](#シナプレ管理くん-詳細要件定義書v1)
  ...
  - [11. 画面一覧](#11-画面一覧)
    - [11.1 認証系](#111-認証系)
    - [11.2 メイン系](#112-メイン系)
    - [11.3 ダッシュボード（/home）](#113-ダッシュボードhome)
  - [12. 画面遷移図](#12-画面遷移図)
  - [13. 非機能要件](#13-非機能要件)
    - [13.1 パフォーマンス](#131-パフォーマンス)
    - [13.2 セキュリティ](#132-セキュリティ)
    - [13.3 ユーザビリティ](#133-ユーザビリティ)
    - [13.4 運用](#134-運用)
  - [14. 非要件（スコープ外）](#14-非要件スコープ外)
  - [15. 将来検討事項](#15-将来検討事項)
  - [16. 用語集](#16-用語集)
  - [17. 実装指示](#17-実装指示)
...
- **位置**: 画面右下固定
- **機能**: ★お気に入りトグル
- **状態**: お気に入り済み → 塗りつぶし / 未登録 → 輪郭のみ
- **上部★との重複**: 初期表示で存在を示すために両方配置
...
#### Spoiler機能
- **目的**: 動画サムネイルによるネタバレ防止
- **デフォルト**: ネタバレ非表示モード（サムネを隠す）
- **切り替え**: スイッチで「ネタバレ表示モード」に変更可能

...
**デザインシステム違反**
- [ ] P0-001: チップコンポーネントのborder削除、shadow適用
- [ ] P0-002: 選択中チップの色をprimary.defaultに変更
- [ ] P0-003: 検索パネルのborder削除、shadow適用
- [ ] P0-004: セマンティックトークンへの移行（rgba, oklch, ハードコード値の削除）
- [ ] P0-005: お気に入りボタンにラベル追加またはFABメニュー統合
- [ ] P0-006: 区切り線を`<hr>`要素に変更
- [ ] P0-007: サイドメニューにテキストラベルまたはARIA label追加
- [ ] P0-008: コントラスト比確保（WCAG AA準拠）
- [ ] P0-009: 「No Image」プレースホルダーのデザイン改善
- [ ] P0-010: ホバー効果に`transform: translateY(-2px)`追加
- [ ] P0-011: システムラベルオーバーレイを半透明+blur
- [ ] P0-012: フォーカス状態の明確化（`_focusVisible`追加）

### P1: 重要な問題（2週間以内に修正）

**UX改善**
- [ ] P1-001: 検索パネルの初期状態を折りたたみに
- [ ] P1-002: シナリオカードのdescriptionを3行まで省略
- [ ] P1-003: 評価表示に星アイコン追加
- [ ] P1-004: 「もっと見る」ボタンを明確に（ChevronDown + テキスト）
- [ ] P1-005: 0件時のメッセージを温かみのあるものに
- [ ] P1-006: ルートページCTAボタンの階層明確化
- [ ] P1-007: Login/Signupボタンをヘッダー右上に移動
- [ ] P1-008: 「続きを読む」をボタン形式に
- [ ] P1-009: FABメニューの展開方向を上左に
- [ ] P1-010: タブの選択状態を背景色+下線で明確化
- [ ] P1-011: 検索ボタンと条件クリアの階層明確化
- [ ] P1-012: ソートUIをタブ形式に変更
- [ ] P1-013: マイページのプロフィール画像を大きく（96px → 128px）
- [ ] P1-014: フォームのエラー表示を追加
- [ ] P1-015: 配布ページリンクにテキスト追加
- [ ] P1-016: セッション作成ボタンの配置を改善
- [ ] P1-017: ホームページのダッシュボード実装
- [ ] P1-018: 検索結果件数の表示を大きく
